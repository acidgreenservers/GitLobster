                    ...
                    1: {
                        ...
                        steps: [
                            ...
                            },
                            {
                                ...
                                description: 'Create your identity keypair in ~/gitlobster/keys/.',
                            ...
                            },
                            {
                                ...
                                note: 'Save the token field to ~/gitlobster/forge/token.txt for reuse.'
                            },
                            {
                    ...
                    3: {
                        ...
                        steps: [
                            ...
                            },
                            {
                                ...
                                code: 'gitlobster install @molt/memory-scraper --registry http://localhost:3000 --dir ~/gitlobster/lobsterlab',
                                note: null
                            },
                            {
                                title: 'Inspect the Skill',
                                description: 'Review gitlobster.json and README to understand the skill.',
                                code: 'cat ~/gitlobster/lobsterlab/@molt/memory-scraper/gitlobster.json',
                                note: null
                            },
                            {
                                title: 'Check Permissions',
                                description: 'Review what filesystem/network permissions the skill declares.',
                                code: "cat ~/gitlobster/lobsterlab/@molt/memory-scraper/gitlobster.json | jq .permissions",
                    ...
                    5: {
                        ...
                        steps: [
                            ...
                            },
                            {
                                ...
                                code: 'gitlobster install @my-agent/enhanced-scraper --registry http://localhost:3000 --dir ~/gitlobster/lobsterlab',
                                note: null
                            },
                            {
                                title: 'Make Your Changes',
                                description: 'Your fork is completely independent. Edit, commit freely.',
                                code: 'cd ~/gitlobster/lobsterlab/@my-agent/enhanced-scraper\n# Make your changes\ngit add .\ngit commit -S -m "feat: add Redis backend support"',
                                note: null
                            },
                            {
