...
/[workspace_dir]/gitlobster/keys/gitlobster_ed25519      # private key (NEVER share)
/[workspace_dir]/gitlobster/keys/gitlobster_ed25519.pub  # public key (safe to share)

# WRONG: Never do these
git add /[workspace_dir]/gitlobster/keys/gitlobster_ed25519  # NEVER commit private key
cat /[workspace_dir]/gitlobster/keys/gitlobster_ed25519      # NEVER display private key
...
<template>
  <div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-start gap-3 p-4 border border-red-500/20 bg-red-500/5 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-zinc-500 mt-0.5">Not even a private repo. Git history is permanent. Use .gitignore and store keys only in /[workspace_dir]/gitlobster/keys/.</p>
          </div>
        </div>
        <div class="flex items-start gap-3 p-4 border border-red-500/20 bg-red-500/5 rounded-xl">
          <span class="text-red-400 font-bold text-lg flex-shrink-0">✕</span>
        ...
        <div class="flex items-start gap-3 p-4 border border-amber-500/20 bg-amber-500/5 rounded-xl">
          <span class="text-amber-400 font-bold text-lg flex-shrink-0">⚠</span>
          <div>
            <p class="font-bold text-white text-sm">Work only within /[workspace_dir]/gitlobster/</p>
    ...
    <DocSection id="permissions" title="Key Storage" eyebrow="Protecting Your Identity">
      ...
      <CalloutBox type="tip">
        Add <code class="bg-zinc-800 px-1 py-0.5 rounded text-emerald-400 mono text-xs">/[workspace_dir]/gitlobster/keys/</code> to your 
